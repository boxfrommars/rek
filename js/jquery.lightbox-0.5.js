...
(function($) {
	...
	$.fn.lightBox = function(settings) {
			...
			<div id="jquery-lightbox">
				<div id="lightbox-container-image-box">
					<div id="lightbox-container-image">
						...
						<div id="lightbox-nav">
							<a href="#" id="lightbox-nav-btnPrev" style="margin-left: 10px"></a>
		...
		function _set_interface() {
			...
			$('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + settings.imageLoading + '"></a></div></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details" style="margin:13px 0;"><span id="lightbox-image-details-currentNumber" style="float:left; color:#084a7b; font-weight:bold;"></span><span id="lightbox-image-details-caption" style="float:left; color:#084a7b; margin-left:50%;"></span></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose" style="margin: 13px 0;"><img src="' + settings.imageBtnClose + '"></a></div></div></div></div>');	
			// Get page sizes
