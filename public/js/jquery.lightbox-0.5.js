...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageBtnPrev:			'img/lightbox/gallery_back.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'img/lightbox/gallery_next.png',			// (string) Path and the name of the next button image
			imageBtnClose:			'img/lightbox/close.png',		// (string) Path and the name of the close btn
		...
		function _set_interface() {
			...
			$('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box" ><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + settings.imageLoading + '"></a></div></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details"><img src="img/lightbox/image_prev.png" style="width:12px; height: 12px; float: left;"><span id="lightbox-image-details-currentNumber" style="float:left; color:#084a7b; font-weight:bold;"></span><img src="img/lightbox/image_next.png" style="width:12px; height: 12px; float: left;"><span id="lightbox-image-details-caption" style="float:right; color:#084a7b; font-size: 14px;"></span></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"><img src="' + settings.imageBtnClose + '"></a></div></div></div></div>');	
			// Get page sizes
