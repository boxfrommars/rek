 ...
 */
class Admin_ProductDecorController extends Whale_Controller_Action_Admin_Article
{
    /**
    ...
    {
        parent::init();
        $this->_model = new Catalog_Model_ProductDecorService();
        $this->_form = new Admin_Form_ProductDecor();
    }
