 ...
 */
class Admin_ProductInterController extends Whale_Controller_Action_Admin_Article
{
    /**
    ...
    {
        parent::init();
        $this->_model = new Catalog_Model_ProductInterService();
        $this->_form = new Admin_Form_ProductInter();
    }
